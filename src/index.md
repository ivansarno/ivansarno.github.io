...
PhD on *Secure Hardware/Software Implementation of Post-Quantum Cryptography on RISC-V Platforms*, carried out at CEA List and TIMA laboratories. Published [KEM22](https://ieeexplore.ieee.org/document/11261742) on IEEE Internet of Things Journal — a hardware accelerator for ML-KEM on ASIC.

**Graduate Researcher — University of Pisa, Electronic Systems Lab** *(Sep 2023 – Sep 2024)*

Developed IPs for True Random Number Generation and Post-Quantum Cryptography acceleration for the RISC-V platform within the European Processor Initiative ([EPI SG2](https://www.european-processor-initiative.eu/project/epi)). Published [CRYPHTOR](https://ieeexplore.ieee.org/document/10439161) on IEEE Access — a hardware accelerator for Kyber and Dilithium on RISC-V. Co-authored an [All-Digital TRNG](https://ieeexplore.ieee.org/document/11271252) paper, also on IEEE Access.
